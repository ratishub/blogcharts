...
// Control that shows data on hover
		...
		info.update = function (props) {
			this._div.innerHTML = '<h4>COMPOSITE SCORE OF TRANSPARENCY AND ACCOUNTABILITY: </h4>' +  (props ?
				'<b>' + props.NAME + '</b>' + ': '+ props.foia_overal_tscore
...
// Add Legend
		...
		legend.onAdd = function (map) {
			...
			'<i style="background:' + '#1a9641' + '"></i> ' + 'Highest (6)'+ '<br>'
			;
			return div;
		};
