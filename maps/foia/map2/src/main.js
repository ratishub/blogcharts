...
// Control that shows data on hover
		...
		info.update = function (props) {
			this._div.innerHTML = '<h4>TRANSPARENCY AND ACCOUNTABILITY SCORE THROUGH FOI: </h4>' +  (props ?
				'<b>' + props.NAME + '</b>' + ': '+ props.foia_foi_score
		...
		function style(feature) {
			return {
				...
				dashArray: '0.3',
				fillOpacity: 0.3,
				fillColor: getColor(feature.properties.foia_foi_score)
			};
		}
...
// Add Legend
		...
		legend.onAdd = function (map) {
			...
			div.innerHTML += '<i style="background:' + '#cccccc' + '"></i> ' + 'Not assessed'+ '<br>'+
			'<i style="background:' + '#d7191c' + '"></i> ' + 'Lowest (0)'+ '<br>'+
			'<i style="background:' + '#fdae61' + '"></i> ' + '1'+ '<br>'+
			'<i style="background:' + '#a6d96a' + '"></i> ' + '2'+ '<br>'+
			'<i style="background:' + '#1a9641' + '"></i> ' + 'Highest (3)'+ '<br>'
			;
			return div;
		};
